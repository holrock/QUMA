...
#_*****************************************************************************
#_*                                                                           *
#_* File name: makeCpGFig6.cgi                                                *
#_* cgi for creating methylation status graph 6                               *
...
for ($i = 0; $i < @pos; $i++) {
	...
	$gd->line ($j, int ((HIGHT - GMARGB2 + GMARGH) / 2),
		   $j, 
		   int ((HIGHT - GMARGB2 + GMARGH) / 2 - (HIGHT - GMARGB2 - GMARGH) / 2 * $meth{$pos[$i]}->{ratio}),
		   $black);
    }

    $gd->rectangle ($x1, int ((HIGHT - GMARGB2 + GMARGH) / 2),
		    $x2,
		    int (HIGHT - GMARGB2  - (HIGHT - GMARGB2 - GMARGH) / 2 * $meth{$pos[$i]}->{ratio}),
		    $black);
}
