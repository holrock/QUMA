...
#_*****************************************************************************
#_*                                                                           *
#_* File name: makeCompFig3.cgi                                               *
#_* cgi for creating methylation status comparison graph 3                    *
...
$gwid  = ($data->{len} - @pos ) * 2 + @pos * GWIDTH2;
...
for ($i = 0; $i < @pos; $i++) {
    ...
    $x = MARGL + ($pos[$i] - $i - 1) * 2 + GWIDTH2 * $i + GWIDTH2 / 2;
    $x1 = $x - GWIDTH2 / 2;
    $x2 = $x1 + GWIDTH2 - 1;
...
if ($data->{down}) {
    ...
    $name .= "_compared_CpG_status_graph3.";
