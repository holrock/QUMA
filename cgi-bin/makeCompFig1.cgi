...
#_*****************************************************************************
#_*                                                                           *
#_* File name: makeCompFig1.cgi                                               *
#_* cgi for creating methylation status comparison graph 1                    *
...
$gd->string   ($font->gdTinyFont,
	       ...
	       'CpG position', $black);
$gd->string   ($font->gdTinyFont,
	       LFMARG + 10, int ((HIGHT - GMARGB + GMARGH) / 2) - 27,
	       'group1', $black);
$gd->string   ($font->gdTinyFont,
	       LFMARG + 10, HIGHT - GMARGB - FONTH1 - 27,
	       'group2', $black);
$gd->string   ($font->gdTinyFont,
...
$gd->string   ($font->gdTinyFont,
	       MARGL - LLABLEN - 1,
	       int ((HIGHT - GMARGB + GMARGH) / 2) - FONTH1-3,
	       '  0%', $black);
$gd->string   ($font->gdTinyFont,
	       MARGL - LLABLEN - 1,
	       int ((HIGHT - GMARGB + GMARGH) / 2) + FONTH1-3,
...
$gd->stringUp ($font->gdTinyFont,
	       MARGL - LLABLEN - LLABMRG - 1+5, HIGHT - GMARGB - FONTH1 - 10,
	       'Methylated (%)', $black);
...
for ($i = 0; $i < @pos; $i++) {
    ...
    $gd->line (MARGL + $pos[$i] - 1,
	       int ((HIGHT - GMARGB + GMARGH) / 2),
	       MARGL + $pos[$i] - 1,
	       int ((HIGHT - GMARGB + GMARGH
		     - (HIGHT - GMARGB - GMARGH) * $meth{$pos[$i]}->{ratio1})/2),
	       $black);
    ...
    $gd->line (MARGL + $pos[$i] - 1,
	       ...
	       MARGL + $pos[$i] - 1,
	       int (HIGHT - GMARGB
		    - (HIGHT - GMARGB - GMARGH) * $meth{$pos[$i]}->{ratio2} / 2),
	       $black);
}
...
if ($data->{down}) {
    ...
    $name .= "_compared_CpG_status_graph1.";
