...
#_*****************************************************************************
#_*                                                                           *
#_* File name: makeCpGFig4.cgi                                                *
#_* cgi for creating methylation status graph 4                               *
...
for ($i = 0; $i < @pos; $i++) {
	...
	$gd->line ($j,
		   HIGHT - GMARGB2,
		   $j,
		   int (HIGHT - GMARGB2 - (HIGHT - GMARGB2 - GMARGH) * $meth{$pos[$i]}->{ratio}),
		   $black);
    }
}
